  ...
  <div class="flex flex-col lg:flex-row gap-12 p-8 sm:p-12 bg-tertiary-500 rounded-lg">
    ...
    <div class="flex-1 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
      <div class="md:col-span-2">
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900 text-primary-500">
        ...
        <ul class="text-gray-500 dark:text-gray-400 list-disc pl-5">
          ...
          <li>Healthcare: Scaling systems to handle 10x transaction volume while improving performance and reliability</li>
        </ul>
      </div>
