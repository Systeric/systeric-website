<section id="hero" class="!pt-20 sm:!pt-28 lg:!pt-36 !pb-14 sm:!pb-20 lg:!pb-24 relative overflow-hidden">
	...
	<div class="max-w-2xl mx-auto text-center relative">
		...
		<p class="text-slate-400 text-[0.95rem] leading-relaxed max-w-lg mx-auto">
		...
		<div class="mt-12 flex flex-wrap justify-center gap-4">
			<a href="#contact-us" class="btn-primary">
				Get in touch
				<svg class="ml-2 w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
