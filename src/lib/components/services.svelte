...
<section class="dark:bg-gray-900">
	<div class="pb-8 mx-auto sm:pb-16">
		...
		<div class="flex items-center gap-12 flex-col sm:flex-row">
			<div class="flex-1">
				<img src={portrait} alt="Team" class="rounded-xl" />
			</div>
			<div class="flex-1 space-y-8 md:grid md:grid-cols-1 md:gap-12 md:space-y-0">
				<div>
					<div
					...
					<p class="text-gray-500 dark:text-gray-400">
						<strong class="text-tertiary-500">Unsure where to take your product next?</strong> Unlock
						a roadmap for success with our expert product strategy services. We'll define your vision,
						analyze the market, and lay out a winning plan.
					</p>
				</div>
				<div>
					<div
					...
					<p class="text-gray-500 dark:text-gray-400">
						<strong class="text-tertiary-500">Want to create a product users love?</strong> Elevate your
				...
				<div>
					...
					<p class="text-gray-500 dark:text-gray-400">
						<strong class="text-tertiary-500">Ready to build your dream software?</strong> Bring your
						vision to life with our custom software development expertise. We deliver robust, user-centric
				...
				<div>
					...
					<p class="text-gray-500 dark:text-gray-400">
						<strong class="text-tertiary-500"
