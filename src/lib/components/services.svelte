<section class="bg-white dark:bg-gray-900">
	<div class="pb-8 mx-auto max-w-screen-xl sm:pb-16">
		...
		<div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
			<div>
				...
				<p class="text-gray-500 dark:text-gray-400">
					<strong class="text-tertiary-500">Unsure where to take your product next?</strong> Unlock a
			...
			<div>
				...
				<p class="text-gray-500 dark:text-gray-400">
					<strong class="text-tertiary-500">Ready to build your dream software?</strong> Bring your vision
